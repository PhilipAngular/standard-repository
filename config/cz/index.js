module.exports = {
  ...
  prompter: function (_cz, _commit) {
    ...
    // Lists
    const typeChoices = [
      { value: 'conf', name: '1- conf: Configurations' },
      { value: 'docs', name: '2- docs: Documentations' },
      { value: 'feat', name: '3- feat: New feature' },
      { value: 'fix', name: '4- fix: A bug fix' },
      { value: 'perf', name: '5- perf: Performances' },
      { value: 'refac', name: '6- refac: Refactories to improve the code' },
      { value: 'style', name: '7- style: Screen style' }
    ];
